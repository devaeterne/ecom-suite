...
-- CreateEnum
CREATE TYPE "ShippingType" AS ENUM ('DELIVERY', 'PICKUP_STORE', 'PICKUP_POINT');

-- CreateEnum
CREATE TYPE "ManualPaymentMethod" AS ENUM ('PAY_AT_STORE', 'BANK_TRANSFER');
...
-- CreateIndex
CREATE INDEX "idx_checkout_tenant_payment_collection" ON "checkout"("tenantId", "paymentCollectionId");
...
-- CreateIndex
CREATE UNIQUE INDEX "uniq_checkout_tenant_payment_collection" ON "checkout"("tenantId", "paymentCollectionId");
...
-- CreateIndex
CREATE UNIQUE INDEX "uniq_checkout_address_tenant_checkout_type" ON "checkout_address"("tenantId", "checkoutId", "type");
...
-- CreateIndex
CREATE INDEX "idx_payment_collection_tenant_idempotency" ON "payment_collection"("tenantId", "idempotencyKey");
...
-- CreateIndex
CREATE UNIQUE INDEX "uniq_payment_collection_tenant_idempotency" ON "payment_collection"("tenantId", "idempotencyKey");
...
-- CreateIndex
CREATE UNIQUE INDEX "uniq_payment_tenant_collection_single_payment" ON "payment"("tenantId", "collectionId");
...
-- AddForeignKey
ALTER TABLE "checkout" ADD CONSTRAINT "checkout_tenantId_paymentCollectionId_fkey" FOREIGN KEY ("tenantId", "paymentCollectionId") REFERENCES "payment_collection"("tenantId", "id") ON DELETE SET NULL ON UPDATE CASCADE;
